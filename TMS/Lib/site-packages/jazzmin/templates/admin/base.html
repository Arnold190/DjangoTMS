...
{% if jazzmin_settings.show_ui_builder %}
<script type="application/json" id="jazzmin-ui-data">
    {{ jazzmin_ui.raw|json_script:"jazzmin-ui-data" }}
</script>
<script>
    window.ui_changes = JSON.parse(document.getElementById('jazzmin-ui-data').textContent);
</script>
<!----
<script>
